        ...
        <style>
         ...
         <div style="padding-top:20px" class="container-fluid">
           ...
           <ul class="nav nav-tabs">
             <li class="nav-item">
               <a class="nav-link active" data-toggle="tab" id="flooring2" href="#flooring">Branding Wall</a>
             </li>
              <li class="nav-item">
               <a class="nav-link" data-toggle="tab" id="Painting2" href="#Painting">Concepts</a>
             </li>
             <li class="nav-item">
               <a class="nav-link" data-toggle="tab" id="Modeldesks2" href="#Modeldesks">Solar System</a>
             </li>
             <li class="nav-item">
               <a class="nav-link" data-toggle="tab" id="Electrical2" href="#Electrical">Innovation Corner </a>
             </li>

             <li class="nav-item">
               <a class="nav-link" data-toggle="tab" id="Cupboards2" href="#Cupboards">Cutouts</a>
             </li>
           </ul>
