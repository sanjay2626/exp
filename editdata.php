      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
         ...
         <!--  <div class="col-sm-3 col-md-2  top_row">
          ...
          <input type="hidden" id="modelesid2" name="modelesid2" value="<?php echo $_GET['moduleid']; ?>">
        </div>
        <div class="row justify-content-center">
          <div class="col-sm-4">
            <button onclick="get_inframodeldata()" style="margin-top:24px;" class="btn form-control btn-lg btn-primary">Edit</button>
          </div>
        </div>
        <hr>
        <div id="content"></div>
      ...
      <script>
        ...
        function get_inframodeldata(){
          ...
          $.ajax({
           ...
           data: {schoolid:schoolid,moduleid:moduleid},
           cache: false,
           type: 'POST',
 ...
 //          });
      ...
      // project drop onchange
        ...
        $("#program_drop").on("change",function(){
          $("#module_drop").html('');
           var modval = $('#modelesid2').val();
           
          // alert(modval); exit;
     for (mod in program_list[$("#program_drop").val()]['module']){
      if(program_list[$("#program_drop").val()]['module'][mod] ==modval){
        var selected = 'selected';
      }else{
        var selected = '';
      }
     $("#module_drop").append('<option value="'+program_list[$("#program_drop").val()]['module'][mod]+'" '+selected+'>'+module_names[program_list[$("#program_drop").val()]['module'][mod]]+'</option>');
              }
