        ...
        <style>
         ...
         <div style="padding-top:20px" class="container-fluid">
           ...
           <ul class="nav nav-tabs">
             <li class="nav-item">
               <a class="nav-link active" data-toggle="tab" id="flooring2" href="#flooring">Electric work </a>
             </li>
              <li class="nav-item">
               <a class="nav-link" data-toggle="tab" id="Painting2" href="#Painting">Model Desk</a>
             </li>
             <li class="nav-item">
               <a class="nav-link" data-toggle="tab" id="Modeldesks2" href="#Modeldesks">Cupboard</a>
             </li>
             <li class="nav-item">
               <a class="nav-link" data-toggle="tab" id="Electrical2" href="#Electrical">Solar power</a>
             </li>
            ...
            $dir = "uploads/".$_GET['user']."/stemlabinfrastc_EWork_Before_".$_GET['schoolid']."/";
            ...
            <div id="Painting" class="tab-pane fade ">
             ...
             <div  class="row justify-content-center">
                <?php
                  // $dir = "/uploads/contract_doc_".$_GET['id'];
            $dir = "uploads/".$_GET['user']."/stemlabinfrastc_modelDesks_Before_".$_GET['schoolid']."/";
                foreach (glob($dir."{*.pdf,*.docx,*.jpg,*.JPG,*.png,*.PNG,*.bmp,*.BMP,*.gif,*.GIF,*.tiff,*.TIFF,*.jpeg,*.JPEG}",GLOB_BRACE) as $file) { ?>
            ...
            <div id="Modeldesks" class="tab-pane fade ">
             ...
             <div class="row justify-content-center" style="padding-top: 20px; text-align: center;display:none" id="Modeldesks_view">
              ...
              <div  class="row justify-content-center">
                <?php
                  // $dir = "/uploads/contract_doc_".$_GET['id'];
            $dir = "uploads/".$_GET['user']."/stemlabinfrastc_cupboard_Before_".$_GET['schoolid']."/";
                foreach (glob($dir."{*.pdf,*.docx,*.jpg,*.JPG,*.png,*.PNG,*.bmp,*.BMP,*.gif,*.GIF,*.tiff,*.TIFF,*.jpeg,*.JPEG}",GLOB_BRACE) as $file) { ?>
            ...
            <div id="Electrical" class="tab-pane fade ">
              ...
              <div  class="row justify-content-center">
                <?php
                  // $dir = "/uploads/contract_doc_".$_GET['id'];
            $dir = "uploads/".$_GET['user']."/stemlabinfrastc_Solar_Before_".$_GET['schoolid']."/";
                foreach (glob($dir."{*.pdf,*.docx,*.jpg,*.JPG,*.png,*.PNG,*.bmp,*.BMP,*.gif,*.GIF,*.tiff,*.TIFF,*.jpeg,*.JPEG}",GLOB_BRACE) as $file) { ?>
