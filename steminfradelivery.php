        ...
        <style>
         ...
         <div style="padding-top:20px" class="container-fluid">
           ...
           <ul class="nav nav-tabs">
             <li class="nav-item">
               <a class="nav-link active" data-toggle="tab" id="ElectricWork2" href="#ElectricWork">Electric Work</a>
             </li>
              <li class="nav-item">
               <a class="nav-link" data-toggle="tab" id="Painting2" href="#Painting">Painting</a>
             </li>
             <li class="nav-item">
               <a class="nav-link" data-toggle="tab" id="Modeldesks2" href="#Modeldesks">Model Desks</a>
             </li>
             <li class="nav-item">
               <a class="nav-link" data-toggle="tab" id="Cupboard2" href="#Cupboard">Cupboard</a>
             </li>

             <li class="nav-item">
               <a class="nav-link" data-toggle="tab" id="Flooring2" href="#Flooring">Flooring</a>
             </li>

             <li class="nav-item">
               <a class="nav-link" data-toggle="tab" id="Solarpower2" href="#Solarpower">Solar power</a>
             </li>
            
           </ul>


             <div id="ElectricWork" class="tab-pane fade active show">
              <!--div for showing images-->
              <div class="row justify-content-center" style="padding-top: 20px; text-align: center;display:none" id="ElectricWork_view">
            ...
            $dir = "uploads/".$_GET['user']."/StemInfraMaterialDelivery_EWork_brefore_".$_GET['schoolid']."/";
            ...
            <div id="Painting" class="tab-pane fade ">
             ...
             <div  class="row justify-content-center">
                <?php
                  // $dir = "/uploads/contract_doc_".$_GET['id'];
            $dir = "uploads/".$_GET['user']."/StemInfraMaterialDelivery_painting_brefore_".$_GET['schoolid']."/";
                foreach (glob($dir."{*.pdf,*.docx,*.jpg,*.JPG,*.png,*.PNG,*.bmp,*.BMP,*.gif,*.GIF,*.tiff,*.TIFF,*.jpeg,*.JPEG}",GLOB_BRACE) as $file) { ?>
            ...
            <div id="Modeldesks" class="tab-pane fade ">
             ...
             <div class="row justify-content-center" style="padding-top: 20px; text-align: center;display:none" id="Modeldesks_view">
              ...
              <div  class="row justify-content-center">
                <?php
                  // $dir = "/uploads/contract_doc_".$_GET['id'];
            $dir = "uploads/".$_GET['user']."/StemInfraMaterialDelivery_modelDesks_brefore_".$_GET['schoolid']."/";
                foreach (glob($dir."{*.pdf,*.docx,*.jpg,*.JPG,*.png,*.PNG,*.bmp,*.BMP,*.gif,*.GIF,*.tiff,*.TIFF,*.jpeg,*.JPEG}",GLOB_BRACE) as $file) { ?>
            ...
            <div id="Cupboard" class="tab-pane fade ">
              <!--div for playing video-->
              <div class="row justify-content-center" style="padding-top: 20px; text-align: center;display:none" id="Cupboard_view">
                <div class="col-sm-9" style='margin-bottom:10px;'>
              ...
              <div  class="row justify-content-center">
                <?php
                  // $dir = "/uploads/contract_doc_".$_GET['id'];
            $dir = "uploads/".$_GET['user']."/StemInfraMaterialDelivery_cupboard_brefore_".$_GET['schoolid']."/";
                foreach (glob($dir."{*.pdf,*.docx,*.jpg,*.JPG,*.png,*.PNG,*.bmp,*.BMP,*.gif,*.GIF,*.tiff,*.TIFF,*.jpeg,*.JPEG}",GLOB_BRACE) as $file) { ?>
            ...
            <div id="Flooring" class="tab-pane fade ">
              ...
              <div  class="row justify-content-center">
                <?php
                  // $dir = "/uploads/contract_doc_".$_GET['id'];
            $dir = "uploads/".$_GET['user']."/StemInfraMaterialDelivery_flooring_brefore_".$_GET['schoolid']."/";
                foreach (glob($dir."{*.pdf,*.docx,*.jpg,*.JPG,*.png,*.PNG,*.bmp,*.BMP,*.gif,*.GIF,*.tiff,*.TIFF,*.jpeg,*.JPEG}",GLOB_BRACE) as $file) { ?>
            ...
            <div id="Solarpower" class="tab-pane fade ">
              <!--div for playing video-->
              <div class="row justify-content-center" style="padding-top: 20px; text-align: center;display:none" id="Solarpower_view">
                <div class="col-sm-9" style='margin-bottom:10px;'>
              ...
              <div  class="row justify-content-center">
                <?php
                  // $dir = "/uploads/contract_doc_".$_GET['id'];
            $dir = "uploads/".$_GET['user']."/StemInfraMaterialDelivery_Solar_brefore_".$_GET['schoolid']."/";
                foreach (glob($dir."{*.pdf,*.docx,*.jpg,*.JPG,*.png,*.PNG,*.bmp,*.BMP,*.gif,*.GIF,*.tiff,*.TIFF,*.jpeg,*.JPEG}",GLOB_BRACE) as $file) { ?>
  ...
  $("#ElectricWork").hide();
   ...
   $("#Solarpower").show();
        ...
        function light_box_images(e){
          ...
          if($("#ElectricWork_view").css("display")=="none"){
          $("#ElectricWork_view").hide().fadeIn(700);
          }
        }
        ...
        function light_box_images4(e){
          ...
          if($("#Cupboard_view").css("display")=="none"){
          $("#Cupboard_view").hide().fadeIn(700);
          }
        }
        ...
        function light_box_images6(e){
          var image2 = $(e).find("img");
          $("#currently_viewing6").prop("src",$(image2).prop("src"));
          if($("#Solarpower_view").css("display")=="none"){
          $("#Solarpower_view").hide().fadeIn(700);
          }
        }
