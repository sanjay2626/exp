...
'<div class="row justify-content-center">\
  <div class="col-sm-4 form_pad col-md-3"  >\
    ...
    <div class="col-sm-4 form_pad col-md-3">\
      ...
      <input id="start_time" value="00:00" name="from_time" class="form-control" type="time" required></input>\
    </div>\
    <div class="col-sm-4 form_pad col-md-3">\
      <h5 class="light">End Time</h5>\
      <input id="end_time" value="00:00" name="to_time" class="form-control" type="time" required></input>\
    </div>\
</div>\
<div class="row justify-content-center">\
    <div  class="col-sm-4 form_pad col-md-3">\
  ...
  <div class="row justify-content-center">\
    <div  class="col-sm-4 form_pad col-md-3">\
      ...
      <input id="batch_size" type="number" min="0" name="batch_size" class="form-control" required>\
    </div>\
    <div class="col-sm-4 form_pad col-md-3">\
      <h5  class="light">Student Count</h5>\
      <input id="student_count" type="number" min="0" name="student_count" class="form-control" required>\
    </div>\
    <div class="col-sm-4 form_pad col-md-3">\
      <h5  class="light">Activity</h5>\
      <input id="activity" type="text" name="activity" class="form-control" required>\
    </div>\
  </div><hr>\
  <div class="row">\
      <div class="col-sm-6">\
        <h5 class="light">Issues (If any)</h5>\
        <textarea name="issues" style="height:150px"  class="form-control"></textarea>\
      </div>\
      <div class="col-sm-6 form_pad">\
        <h5 class="light" align="center" style="margin-bottom:70px">Session Rating</h5>\
        <input id="ran" value="9"  type="range"  min="0" max="10" name="rate"   required>\
      </div>\
    </div>\
    <div class="row">\
      <div class="col-sm-6">\
