        ...
        <style>
         ...
         <div style="padding-top:20px" class="container-fluid">
           ...
           <ul class="nav nav-tabs">
            <li class="nav-item">
               <a class="nav-link active" data-toggle="tab" id="Electrical2" href="#Electrical">School Photos</a>
             </li>
             <li class="nav-item">
               <a class="nav-link" data-toggle="tab" id="Painting2" href="#Painting">Room Photos</a>
             </li>
           </ul>
            ...
            $dir = "uploads/school_room_photos_".$_GET['schoolid']."/";
                foreach (glob($dir."{*.pdf,*.docx,*.jpg,*.JPG,*.png,*.PNG,*.bmp,*.BMP,*.gif,*.GIF,*.tiff,*.TIFF,*.jpeg,*.JPEG,*.jfif}",GLOB_BRACE) as $file) { ?>
                   ...
                   <div  class="col-md-2 col-sm-6  padded" style="text-align:center">
                      <div onclick="light_box_images(this)"  class="shadow" style="cursor:pointer; border-radius:10px;">
                        <img style="height: 350px;width: 500px; border-radius:10px 10px 0px 0px" src="<?php echo $file; ?>">
            ...
            <div id="Painting" class="tab-pane fade ">
             ...
             <div  class="row justify-content-center">
                <?php
                  // $dir = "/uploads/contract_doc_".$_GET['id'];
            $dir = "uploads/school_photos_".$_GET['schoolid']."/";
                foreach (glob($dir."{*.pdf,*.docx,*.jpg,*.JPG,*.png,*.PNG,*.bmp,*.BMP,*.gif,*.GIF,*.tiff,*.TIFF,*.jpeg,*.JPEG,*.jfif}",GLOB_BRACE) as $file) { ?>
                  ...
                  <?php }  ?>
                    ...
                    $user_id = $_GET['user'];
                  // $dir = "/uploads/contract_doc_".$_GET['id'];
            $dir2 = 'uploads/'.$_GET['user'].'/stem_infra_EWork_brefore_'.$_GET['school2']."/";
           
                foreach (glob($dir2."{*.pdf,*.docx,*.jpg,*.JPG,*.png,*.PNG,*.bmp,*.BMP,*.gif,*.GIF,*.tiff,*.TIFF,*.jpeg,*.JPEG,*.jfif}",GLOB_BRACE) as $file2) { ?>


                   <div  class="col-md-2 col-sm-6  padded" style="text-align:center">
                      <div onclick="light_box_images2(this)"  class="shadow" style="cursor:pointer; border-radius:10px;">
                        <img style="height: 350px;width: 500px; border-radius:10px 10px 0px 0px" src="<?php echo $file2; ?>">
                        <h6 style="padding-top:5px; padding-bottom:5px" class="light" align="center"><?php echo explode("_",pathinfo($file2,PATHINFO_FILENAME),3)[2]; ?> </h6>
                      </div>
                      <?php if (in_array("16",$_SESSION['permissions']) || in_array("14",$_SESSION['permissions'])) { ?>
                       <hr class="newur">
                        <h6 onclick="stem_schools4('<?php echo $file2; ?>')" style="padding-top:5px; padding-bottom:5px;color: red;" class="light " align="center">Delete File</h6> <?php } ?>
                    </div>
                  <?php }  ?>
              </div>
            </div>
            ...
            <div id="Modeldesks" class="tab-pane fade ">
             ...
             <div class="row justify-content-center" style="padding-top: 20px; text-align: center;display:none" id="Modeldesks_view">
              ...
              <div  class="row justify-content-center">
                <?php
                  // $dir = "/uploads/contract_doc_".$_GET['id'];
            $dir = "uploads/".$_GET['user']."/stem_infra_modelDesks_brefore_".$_GET['schoolid']."/";
                foreach (glob($dir."{*.pdf,*.docx,*.jpg,*.JPG,*.png,*.PNG,*.bmp,*.BMP,*.gif,*.GIF,*.tiff,*.TIFF,*.jpeg,*.JPEG,*.jfif}",GLOB_BRACE) as $file) { ?>
            ...
            <div id="Electrical" class="tab-pane fade ">
              ...
              <div  class="row justify-content-center">
                <?php
                  // $dir = "/uploads/contract_doc_".$_GET['id'];
            $dir = "uploads/".$_GET['user']."/stem_infra_EWork_brefore_".$_GET['schoolid']."/";
                foreach (glob($dir."{*.pdf,*.docx,*.jpg,*.JPG,*.png,*.PNG,*.bmp,*.BMP,*.gif,*.GIF,*.tiff,*.TIFF,*.jpeg,*.JPEG,*.jfif}",GLOB_BRACE) as $file) { ?>
            ...
            <div id="Cupboards" class="tab-pane fade ">
              ...
              <div  class="row justify-content-center">
                <?php
                  // $dir = "/uploads/contract_doc_".$_GET['id'];
            $dir = "uploads/".$_GET['user']."/stem_infra_cupboard_brefore_".$_GET['schoolid']."/";
                foreach (glob($dir."{*.pdf,*.docx,*.jpg,*.JPG,*.png,*.PNG,*.bmp,*.BMP,*.gif,*.GIF,*.tiff,*.TIFF,*.jpeg,*.JPEG,*.jfif}",GLOB_BRACE) as $file) { ?>
