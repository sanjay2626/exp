...
// $infradata = "select * from project_school inner join school on school.id=project_school.school_id where project_school.project_id = '".$_GET['pid']."' and project_school.delete_flag=0 order by school.city";
//  $result = $con -> query($infradata);


try{
     
    // $link = new \PDO(   'mysql:host=localhost;dbname=devdashboard;charset=utf8mb4', 
    //                     'root', 
    //                     '', 
    //                     array(
